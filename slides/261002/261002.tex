...
\begin{frame}
 ...
 \begin{tabularx}{\textwidth}{Xp{.7\textwidth}}
  \centering
  \raisebox{-7.5zw}{\includegraphics[scale=0.6]{compilerstruct-crop.pdf}}
  &
...
\begin{figure}
\centering
\includegraphics[height=.65\textheight]{sly-template-crop.pdf}
\end{figure}
{\small
$\texttt{tokens}$にトークンの名前を列挙して，下のその名前のトークンを正規表現で定義\\
pythonプログラムを生成するわけでなく，このプログラムで字句解析}
\end{frame}
